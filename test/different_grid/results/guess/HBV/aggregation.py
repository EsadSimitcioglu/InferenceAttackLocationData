...
from LDP.protocols import HBV_Client, HBV_Aggregator, SIMPLE_RAPPOR_Client, SIMPLE_RAPPOR_Aggregator
...
for epsilon in epsilon_list:
    ...
    seed_value = 1
    for user_true_values in users_grid_value_list:
        perturbed_bit_vector_list.append(HBV_Client(user_true_values, epsilon, seed_value))
        seed_value += 1
