...
from LDP.estimation_different_grid import RAPPOR_estimated_guess, RAPPOR_advance_estimated_guess, RAPPOR_FK_estimated_guess
...
probability_of_guess_rappor_advance = list()
probability_of_guess_rappor_fk = list()
...
for epsilon in epsilon_list:
    ...
    probability_of_guess_rappor_advance.append(RAPPOR_advance_estimated_guess(users_grid_value_list, k, epsilon, 1))
    print("Advance RAPPOR is Ready")
    probability_of_guess_rappor_fk.append(RAPPOR_FK_estimated_guess(users_grid_value_list, k, epsilon, 'guess'))
    print("FK RAPPOR is Ready")


print(probability_of_guess_rappor_plain)
print(probability_of_guess_rappor_advance)
print(probability_of_guess_rappor_fk)
plt.ylim(0, 1)
...
plt.plot(epsilon_list, probability_of_guess_rappor_advance, label='RAPPOR-Advance', color='blue')
plt.plot(epsilon_list, probability_of_guess_rappor_fk, label='RAPPOR-FK', color='yellow')
