...
rappor_list_plain_on_stationary = [
    0.08423650225794538,
    0.12678243631057695,
    0.18437278228487214,
    0.25753844572768775,
...
olh_list_plain_on_stationary = [
    0.025888209014528277,
    0.016767715402698075,
    0.0015538841239425786,
    0.14618872768480004,
    0.24361252521985727,
    0.3716959770754203,
    0.5158785749360235,
...
grr_list_plain_on_stationary = grr_list_plain_on_stationary[1:9:2] + [
    grr_list_plain_on_stationary[-1]
]
rappor_list_plain_on_stationary = rappor_list_plain_on_stationary[1:9:2] + [
    rappor_list_plain_on_stationary[-1]
]
oue_list_plain_on_stationary = oue_list_plain_on_stationary[1:9:2] + [
    oue_list_plain_on_stationary[-1]
]
olh_list_plain_on_stationary = olh_list_plain_on_stationary[1:9:2] + [
    olh_list_plain_on_stationary[-1]
]
...
plt.bar(
    epsilon_list_with_margin - 1.5 * bar_width,
    grr_list_plain_on_stationary,
    width=bar_width,
    color="purple",
    label="GRR",
...
plt.bar(
    epsilon_list_with_margin - 0.5 * bar_width,
    rappor_list_plain_on_stationary,
    width=bar_width,
    color="grey",
    label="RAPPOR",
